    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_url', models.URLField(default=b'http://localhost:8000', help_text='(Read-only) base URL for the server where the master copy of the associated language resource is located.', editable=False)),
                ...
                ('legacy_resource', models.BooleanField(default=False, help_text='Specifies whether the resource is collected by ELRI 1')),
                ...
                ('publication_status', models.CharField(default=b'i', help_text='Generalized publication status flag for this storage object instance.', max_length=1, choices=[(b'i', b'internal'), (b'g', b'ingested'), (b'r', b'processing'), (b'e', b'error'), (b'p', b'published')])),
